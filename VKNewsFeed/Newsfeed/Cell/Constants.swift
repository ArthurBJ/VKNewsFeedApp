...
//  VKNewsFeed
//
//  Created by Артур Байбиков on 06.09.2023.
//

import UIKit

struct Constants {
    static let cardInstets = UIEdgeInsets(top: 0, left: 8, bottom: 12, right: 8)
    ...
    static let bottimViewViewsIconSize: CGFloat = 24
